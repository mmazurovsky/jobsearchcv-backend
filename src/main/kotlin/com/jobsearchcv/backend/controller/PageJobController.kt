...
class PageJobController(
    ...
    @Operation(
        ...
        description = "Fetches jobs sent to the user in the last 24 hours (1440 minutes) for page display. No authentication required."
    )
    fun getPageJobs(
        ...
        logger.debug("Received request for page jobs: userId=$userId, minutesBack=$minutesBack")
        ...
        val jobs = pageJobService.getPageJobsForUser(userId, minutesBack)
